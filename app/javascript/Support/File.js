...
File.addUser = function (UserId, Name, Password, rememberPassword) {
	...
	if (openRead) {
		...
		if (userFound == false) {
			...
			view2 = Server.getItemTypeURL("&IncludeItemTypes=Movie&SortBy=DateCreated&SortOrder=Descending&fields=SortName&CollapseBoxSetItems=false&ExcludeLocationTypes=Virtual&recursive=true&Filters=IsUnplayed");
