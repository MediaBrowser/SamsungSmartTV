...
GuiPage_Music.keyDown = function() {
	...
	switch(keyCode) {	
		...
		case tvKey.KEY_BLUE:
			if (this.selectedItem == -1) {
				GuiMusicPlayer.showMusicPlayer("GuiPage_Music",this.topMenuItems[this.selectedItem2],"guiMusic_Global highlightBackground");
			} else {
				GuiMusicPlayer.showMusicPlayer("GuiPage_Music",this.playItems[this.selectedItem2]+this.AlbumData.Items[this.selectedItem].Id,"guiMusic_TableTd highlightBackground");
			}
			break;		
		case tvKey.KEY_EXIT:
			alert ("EXIT KEY");
...
GuiPage_Music.openMenu = function() {
	...
	if (this.selectedItem == -1) {
		GuiMainMenu.requested("GuiPage_Music",this.topMenuItems[this.selectedItem2],"guiMusic_Global highlightBackground");
	} else {
		GuiMainMenu.requested("GuiPage_Music",this.playItems[this.selectedItem2]+this.AlbumData.Items[this.selectedItem].Id,"guiMusic_TableTd highlightBackground");
	}
}
...
GuiPage_Music.processSelectedItem = function() {
	if (this.selectedItem == -1) {
		...
		case 0:
			//Play All
			document.getElementById(this.topMenuItems[this.selectedItem2]).className = document.getElementById(this.topMenuItems[this.selectedItem2]).className.replace("highlightBackground","");
		...
		case 0:
			//Play
			document.getElementById(this.playItems[this.selectedItem2]+this.AlbumData.Items[this.selectedItem].Id).className = document.getElementById(this.playItems[this.selectedItem2]+this.AlbumData.Items[this.selectedItem].Id).className.replace("highlightBackground","");
